    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers(HttpMethod.POST, "/api/auth/login/admin").permitAll()    // rota de login de admin
                        .requestMatchers(HttpMethod.POST, "/api/auth/register/admin").hasAuthority("admin")// rota de sing-up de admin
                        .requestMatchers(HttpMethod.POST, "/api/auth/register/patient").hasAuthority("admin") // rota de sign-in paciente, permitindo com que o admin cadastre ele
                        .requestMatchers(HttpMethod.POST, "/api/auth/login/patient").permitAll() // rota de login do paciente
                        .requestMatchers(HttpMethod.POST, "/api/exercise/create-exercise").permitAll()
